...
public enum XMaterial {
    ...
    private static int VERSION = Integer.parseInt(getMajorVersion(Bukkit.getVersion()).substring(2));
    private static boolean ISFLAT = supports(13);
    private byte data;
    ...
    public Material parseMaterial(boolean suggest) {
        ...
        if (cache != null) {
            return cache.orElse(Material.AIR);
        }
        Material mat;
